...
import { Video, Code, Music, Palette, Camera, LineChart, Gamepad, Book, Cloud, Coffee, Brush, Smartphone, Search } from 'lucide-react';
import { motion } from 'framer-motion';
import { supabase, type Category } from '../lib/supabase';
import toast from 'react-hot-toast';

const iconMap: { [key: string]: any } = {
  Video, Code, Music, Palette, Camera, LineChart,
